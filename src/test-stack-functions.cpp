 ...
 */
/* */
TEST_CASE("<doParenthesisMatch()> test doParenthesismatch function", "[task2]")
{
 ...
 */
/* */
TEST_CASE("<decodeIDSequence()> test decodeIDSequence function", "[task3]")
{
 ...
 */
/* */
TEST_CASE("<insertItemOnSortedStack()> test insertItemOnSorted function", "[task4]")
{
 ...
 */
/* */
TEST_CASE("<sortStack()> test sortStack function", "[task5]")
{
